#!/usr/bin/env bun
/**
 * agent-tool-registry - Dynamic AI agent tool discovery and registration hub with capability matching and version management
...
program.name("agent-tool-registry").description("Dynamic AI agent tool discovery and registration hub with capability matching and version management").version("1.0.0")
